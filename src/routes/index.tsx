...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-[-20px] bottom-[-60px] sm:left-0 sm:bottom-[-40px] md:bottom-[-60px] lg:bottom-[-20px] h-[160px] w-[160px] pointer-events-none select-none sm:h-[220px] sm:w-[220px] md:h-[280px] md:w-[280px] lg:h-[340px] lg:w-[340px] z-20"
        style={{ opacity: 0.35 }}
      >
        <img
...
function Profile() {
  return (
    <section id="perfil" className="relative bg-beige-soft/60 py-28 sm:py-40">
      ...
      <div
        className="absolute right-0 top-24 lg:top-48 h-[160px] w-[160px] pointer-events-none select-none sm:h-[220px] sm:w-[220px] md:h-[280px] md:w-[280px] lg:h-[340px] lg:w-[340px]"
        style={{ opacity: 0.25 }}
      >
        <img
      ...
      <div className="mx-auto max-w-4xl px-6 text-center sm:px-10 relative z-20">
        ...
        <Reveal delay={0.35}>
          <div className="mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-muted-foreground">
            ...
            <a
              href="https://www.linkedin.com/in/catalina-wauthier/"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 transition-colors hover:text-foreground"
            >
              <Linkedin className="h-4 w-4" /> Catalina Wauthier
            </a>
